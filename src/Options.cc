...
void parse_commandline(int argc, char *argv[]) {
  try {
    ...
    desc.add_options()("help,h", "Help screen")
        ...
        ("prob_threshold", po::value<double>(&options.prob_threshold), "prob_threshold")
        ("disparity_threshold", po::value<double>(&options.disparity_threshold), "disparity_threshold");
